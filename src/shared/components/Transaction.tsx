...
export default function TransactionComponent() {
    ...
    const getFilterData = () => {
        try {
            setLoading(true)
            const result = data?.filter((result: any) => result?.id?.toLowerCase().includes(debounceInput));
    ...
    return (
        <div className="halo">
            ...
            <div style={{
                ...
                <h3>Result: {filterData?.length} Trsansaction</h3>
